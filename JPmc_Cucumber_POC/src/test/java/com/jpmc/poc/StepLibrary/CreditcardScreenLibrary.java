package com.jpmc.poc.StepLibrary;

import java.io.IOException;

import org.apache.commons.configuration.ConfigurationException;
import com.jpmc.poc.Constant.CreditcardsUIConstants;
import com.jpmc.poc.Constant.HomeScreenUIConstants;
		...
		try{	
			if(config.getString("breakPoint").equalsIgnoreCase("Mobile")){
				...
				if(isElementPresentVerification(CreditcardsUIConstants.creditCards_Screen_IMG)){
					...
					accessibilityValidation(CreditcardsUIConstants.creditCards_Screen_IMG, CreditcardsUIConstants.creditCards_Screen_IMG_Accessibility, CreditcardsUIConstants.creditCards_Screen_NameOf_Logo);
